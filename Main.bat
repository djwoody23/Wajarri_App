...
CALL :GENERATESEPARATOR __TEXT " " 80
CALL :GENERATESEPARATOR -_TEXT "Ä" 80
CALL :GENERATESEPARATOR #_TEXT "Û" 80
CALL :GENERATESEPARATOR @_TEXT "±" 80
...
CALL :MENUITEM BUILDRES		O "Build Resources"
CALL :MENUITEM INITPLATFORM I "Initialize Platform"
...
SET MAINMENU_LIST="# # _ PROJECT DIRECTORY APK APK_ZIP APK_PACKAGE APK_ACTIVITY APK_SIZE PGB_ID _ - _ SETDIR SETAPK _ - _ EMULATOR LOGAPK LOGERROR _ - _ COMPRESS DOWNLOAD _ BUILDRES INITPLATFORM _ BUILDAPK INSTAPK RUNAPK _ - _ COMMAND PROMPT _ GITGUI _ - _ HELP RESTART QUIT _ @ _"
...
CALL :UPDATE_ID
:STATUS
CALL pgbuild buildstatus %PGB_ID%
ECHO TODO ADD BUILD STATUS CHECK
::GOTO :STATUS
ECHO.
ECHO DOWNLOADING
ECHO.%ERRORLEVEL%
